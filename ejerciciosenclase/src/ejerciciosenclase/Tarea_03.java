...
public class Tarea_03 {
	public static void main(String[] args) {
		...
		double c, f;
		System.out.println("Ingrese valores de Fahrenheit para convertirlo a celsius");
		f = lector.nextDouble();{
		 ...
		 c =((f - 32) * (5.0 / 9.0));
		  ...
		  System.out.println("<<<----------------------------------------------------->>>");
		  System.out.println("Ingrese valores de Celsius para convertirlo a Fahrenheit");
		    c = lector.nextDouble();{
